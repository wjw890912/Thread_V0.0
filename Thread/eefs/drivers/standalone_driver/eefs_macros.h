...
#ifdef USE_EEPROM
#define EEFS_LIB_EEPROM_WRITE(Dest, Src, Length) Write_EEPROM(Dest, Src, Length)
#define EEFS_LIB_EEPROM_READ(Dest, Src, Length)  Read_EEPROM(Dest, Src, Length)
...
#define  Get_current_time()	  0x0001
