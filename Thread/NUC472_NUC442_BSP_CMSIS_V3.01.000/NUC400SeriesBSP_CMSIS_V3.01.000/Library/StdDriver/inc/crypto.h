...
#define TDES_MODE_ECB           0       /*!< TDES select ECB mode                    \hideinitializer */
#define TDES_MODE_CBC           1       /*!< TDES select CBC mode                    \hideinitializer */
#define TDES_MODE_CFB           2       /*!< TDES select CFB mode                    \hideinitializer */
#define TDES_MODE_OFB           3       /*!< TDES select OFB mode                    \hideinitializer */
#define TDES_MODE_CTR           4       /*!< TDES select CTR mode                    \hideinitializer */
...
#define PRNG_ENABLE_INT()       (CRPT->INTEN |= CRPT_INTEN_PRNGIEN_Msk)                           /*!< Enable PRNG interrupt       \hideinitializer */
#define PRNG_DISABLE_INT()      (CRPT->INTEN &= ~CRPT_INTEN_PRNGIEN_Msk)                          /*!< Disable PRNG interrupt      \hideinitializer */
#define PRNG_GET_INT_FLAG()     (CRPT->INTSTS & CRPT_INTSTS_PRNGIF_Msk)                           /*!< Get PRNG interrupt flag     \hideinitializer */
#define PRNG_CLR_INT_FLAG()     (CRPT->INTSTS = CRPT_INTSTS_PRNGIF_Msk)                           /*!< Clear PRNG interrupt flag   \hideinitializer */
#define AES_ENABLE_INT()        (CRPT->INTEN |= (CRPT_INTEN_AESIEN_Msk|CRPT_INTEN_AESERRIEN_Msk)) /*!< Enable AES interrupts       \hideinitializer */
#define AES_DISABLE_INT()       (CRPT->INTEN &= ~(CRPT_INTEN_AESIEN_Msk|CRPT_INTEN_AESERRIEN_Msk))/*!< Disable AES interrupts      \hideinitializer */
#define AES_GET_INT_FLAG()      (CRPT->INTSTS & (CRPT_INTSTS_AESIF_Msk|CRPT_INTSTS_AESERRIF_Msk)) /*!< Get AES interrupt flag      \hideinitializer */
#define AES_CLR_INT_FLAG()      (CRPT->INTSTS = (CRPT_INTSTS_AESIF_Msk|CRPT_INTSTS_AESERRIF_Msk)) /*!< Clear AES interrupt flag    \hideinitializer */
#define AES_ENABLE_KEY_PROTECT()  (CRPT->AES_CTL |= CRPT_AES_CTL_KEYPRT_Msk)                      /*!< Protect AES key             \hideinitializer */
#define AES_DISABLE_KEY_PROTECT() (CRPT->AES_CTL = (CRPT->AES_CTL & ~CRPT_AES_CTL_KEYPRT_Msk) | (0x16<<CRPT_AES_CTL_KEYUNPRT_Pos)) /*!< Un-protect AES key. AES keys will be cleared.   \hideinitializer */
#define TDES_ENABLE_INT()       (CRPT->INTEN |= (CRPT_INTEN_TDESIEN_Msk|CRPT_INTEN_TDESERRIEN_Msk))  /*!< Enable TDES interrupts      \hideinitializer */
#define TDES_DISABLE_INT()      (CRPT->INTEN &= ~(CRPT_INTEN_TDESIEN_Msk|CRPT_INTEN_TDESERRIEN_Msk)) /*!< Disable TDES interrupts     \hideinitializer */
#define TDES_GET_INT_FLAG()     (CRPT->INTSTS & (CRPT_INTSTS_TDESIF_Msk|CRPT_INTSTS_TDESERRIF_Msk))  /*!< Get TDES interrupt flag     \hideinitializer */
#define TDES_CLR_INT_FLAG()     (CRPT->INTSTS = (CRPT_INTSTS_TDESIF_Msk|CRPT_INTSTS_TDESERRIF_Msk))  /*!< Clear TDES interrupt flag   \hideinitializer */
#define TDES_ENABLE_KEY_PROTECT()  (CRPT->TDES_CTL |= CRPT_TDES_CTL_KEYPRT_Msk)                   /*!< Protect TDES key           \hideinitializer */
#define TDES_DISABLE_KEY_PROTECT() (CRPT->TDES_CTL = (CRPT->TDES_CTL & ~CRPT_TDES_CTL_KEYPRT_Msk) | (0x16<<CRPT_TDES_CTL_KEYUNPRT_Pos)) /*!< Un-protect TDES key. TDES keys will be cleared.   \hideinitializer */
#define SHA_ENABLE_INT()        (CRPT->INTEN |= (CRPT_INTEN_SHAIEN_Msk|CRPT_INTEN_SHAERRIEN_Msk)) /*!< Enable SHA interrupts       \hideinitializer */
#define SHA_DISABLE_INT()       (CRPT->INTEN &= ~(CRPT_INTEN_SHAIEN_Msk|CRPT_INTEN_SHAERRIEN_Msk))/*!< Disable SHA interrupts      \hideinitializer */
#define SHA_GET_INT_FLAG()      (CRPT->INTSTS & (CRPT_INTSTS_SHAIF_Msk|CRPT_INTSTS_SHAERRIF_Msk)) /*!< Get SHA interrupt flag      \hideinitializer */
#define SHA_CLR_INT_FLAG()      (CRPT->INTSTS = (CRPT_INTSTS_SHAIF_Msk|CRPT_INTSTS_SHAERRIF_Msk)) /*!< Clear SHA interrupt flag    \hideinitializer */
