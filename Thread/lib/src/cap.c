 ...
 *
 * @param[in]  u32InFormat  The bits corresponding VSP, HSP, PCLK, PDORD, INDATORD, SENTYPE, OUTFMT and PDORD
 *             VSP, It should be following addition of some :
 *                      - \ref CAP_PAR_VSP_LOW
 *                      - \ref CAP_PAR_VSP_HIGH
 *
 *             HSP, It should be following addition of some :
 *                      - \ref CAP_PAR_HSP_LOW
 *                      - \ref CAP_PAR_HSP_HIGH
 *
 *             PCLK, It should be following addition of some:
 *                      - \ref CAP_PAR_PCLKP_LOW
 *                      - \ref CAP_PAR_PCLKP_HIGH
 *
 *             INFMT, It should be following addition of some :
 *                      - \ref CAP_PAR_INFMT_YUV422
 *                      - \ref CAP_PAR_INFMT_RGB565
 *
 *             SNRTYPE, It should be following addition of some :
 *                      - \ref CAP_PAR_SENTYPE_CCIR601
 *                      - \ref CAP_PAR_SENTYPE_CCIR656
 *
