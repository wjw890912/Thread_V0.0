...
/**
  ...
  * @param  tCAN    The base address of can module.
...
/**
  ...
  *                             CAN_TESTR_TX0_Msk/CAN_TESTR_TX1_Msk: Control CAN_TX pin bit feild
  * @return   None
...
/**
  ...
  * @param    tCAN        The base address of can module.
  * @param    u8MsgObj    Specifies the Message object number, from 0 to 31.
...
/**
  ...
  * @param    u8MsgObj    Specifies the Message object number, from 0 to 31.
  * @param    u8idType    Specifies the identifier type of the frames that will be transmitted
  *                       This parameter can be one of the following values:
  *                       CAN_STD_ID (standard ID, 11-bit)
  *                       CAN_EXT_ID (extended ID, 29-bit)
  * @param    u32id       Specifies the identifier used for acceptance filtering.
  * @param    u8singleOrFifoLast  Specifies the end-of-buffer indicator.
  *                                 This parameter can be one of the following values:
...
/**
  ...
  * @param    u8MsgObj    Specifies the Message object number, from 0 to 31.
  * @param    u8Release   Specifies the message release indicator.
  *                       This parameter can be one of the following values:
...
/**
  ...
  *
  * @param    tCAN        The base address of can module
  * @param    u32BaudRate The target CAN baud-rate. The range of u32BaudRate is 1~1000KHz
  *
...
/**
  ...
  * @param    tCAN        The base address of can module
  * @param    u32BaudRate The target CAN baud-rate. The range of u32BaudRate is 1~1000KHz
  * @param    u32Mode     The CAN operation mode. (CAN_NOTMAL_MODE / CAN_BASIC_MODE)
  *
  * @return   u32CurrentBitRate  Real baud-rate value
  */
...
/**
  ...
  *
  * @param    tCAN       The base address of can module.
  * @param    u32Mask    Interrupt Mask. (CAN_CON_IE_Msk / CAN_CON_SIE_Msk / CAN_CON_EIE_Msk)
  *
  * @return   None
  */
...
/**
  ...
  * @param    tCAN        The base address of can module.
  * @param    u32MsgNum   Specifies the Message object number, from 0 to 31
  * @param    u32IDType   Specifies the identifier type of the frames that will be transmitted. (CAN_STD_ID / CAN_EXT_ID)
  * @param    u32ID       Specifies the identifier used for acceptance filtering.
  *
  * @return   FALSE: No useful interface \n
...
/**
  ...
  *
  * @param    tCAN        The base address of can module.
  * @param    u32MsgNum   The starting MSG RAM number. (0 ~ 31)
  * @param    u32MsgCount the number of MSG RAM of the FIFO.
  * @param    u32IDType   Specifies the identifier type of the frames that will be transmitted. (CAN_STD_ID / CAN_EXT_ID)
  * @param    u32ID       Specifies the identifier used for acceptance filtering.
  *
  * @return   FALSE: No useful interface \n
...
/**
  ...
  * @param    pCanMsg     Pointer to the message structure where received data is copied.
  *
  * @return   FALSE: 1. When operation in basic mode: Transmit message time out. \n
