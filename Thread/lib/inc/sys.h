...
//SYS->RSTSTS
#define  SYS_RSTSTS_CPUINST       (0x1UL<<SYS_RSTSTS_CPUINST_Pos)       /*!<CPU Instant  Priority.  \hideinitializer */
#define  SYS_RSTSTS_CPU           (0x1UL<<SYS_RSTSTS_RSTS_CPU_Pos)      /*!<writing bit SYS_CPU_RST in IPRST0 cause reset.  \hideinitializer */
#define  SYS_RSTSTS_SYSTEM        (0x1UL<<SYS_RSTSTS_RSTS_SYS_Pos)      /*!<Writing bit SYSRESETREQ in AIRCR cause reset.  \hideinitializer */
#define  SYS_RSTSTS_BOD           (0x1UL<<SYS_RSTSTS_RSTS_BOD_Pos)      /*!<It cause reset that VCC is lower than BOD voltage.  \hideinitializer */
#define  SYS_RSTSTS_LVR           (0x1UL<<SYS_RSTSTS_RSTS_LVR_Pos)      /*!<It cause reset that VCC is lower than LVRvoltage.   \hideinitializer */
#define  SYS_RSTSTS_WDT           (0x1UL<<SYS_RSTSTS_RSTS_WDT_Pos)      /*!<WDT cause reset.  \hideinitializer */
#define  SYS_RSTSTS_RST           (0x1UL<<SYS_RSTSTS_RSTS_RESET_Pos)    /*!<Pulling down Reset pin cause reset.   \hideinitializer */
#define  SYS_RSTSTS_POR           (0x1UL<<SYS_RSTSTS_RSTS_POR_Pos)      /*!<Power on cause reset.  \hideinitializer */
...
/*---------------------------------------------------------------------------------------------------------*/
#define SYS_TEMPCR_VTEMP_EN (0x1UL<<SYS_TEMPCR_VTEMP_EN_Pos)     /*!<Temperature sensor function Enabled \hideinitializer */

/*---------------------------------------------------------------------------------------------------------*/
/*  VREFCR constant definitions. (Write-Protection Register)                                               */
/*---------------------------------------------------------------------------------------------------------*/
#define SYS_VREFCRT_VREF_ENG    (0x1UL<<SYS_VREFCTL_VREFCTL_Pos)    /*!<VREF current band-gap  Enabled \hideinitializer */
#define SYS_VREFCRT_VREF_ENREG  (0x2UL<<SYS_VREFCTL_VREFCTL_Pos)    /*!<  VREF regulator  out Enabled  \hideinitializer */
#define SYS_VREFCRT_VREF_2_56V  (0x0UL<<SYS_VREFCTL_VREFCTL_Pos)    /*!<  VOUT= 2.56V  \hideinitializer */
#define SYS_VREFCRT_VREF_2_048V (0x4UL<<SYS_VREFCTL_VREFCTL_Pos)    /*!< VOUT= 2.048V  \hideinitializer */
#define SYS_VREFCRT_VREF_3_072V (0x8UL<<SYS_VREFCTL_VREFCTL_Pos)    /*!< VOUT= 3.072V  \hideinitializer */
#define SYS_VREFCRT_VREF_4_096V (0xCUL<<SYS_VREFCTL_VREFCTL_Pos)    /*!< VOUT= 4.096V  \hideinitializer */
#define SYS_VREFCTL_ADC_VREFSEL (0x10UL<<SYS_VREFCTL_VREFCTL_Pos)   /*!< AVDD connected  \hideinitializer */
#define SYS_VREFCTL_ADC_SEL     (0x1UL<<SYS_VREFCTL_ADCMODESEL_Pos)     /*!< ADC mode  \hideinitializer */
#define SYS_VREFCTL_PWM_MODE    (0x1UL<<SYS_VREFCTL_PWMSYNCMODE_Pos)    /*!<PWM SYNC MODE ENABLED, PWM engine clock is same as HCLK  \hideinitializer */
...
#define SYS_GPA_MFPL_PA1MFP_TAMPER0     (0x1UL<<SYS_GPA_MFPL_PA0MFP_Pos)            /*!< GPA_MFPL PA1 setting for TAMPER1   \hideinitializer */
...
#define SYS_GPD_MFPH_PD13MFP_SC3_SS0         (0x1UL<<SYS_GPD_MFPH_PD13MFP_Pos)           /*!< GPD_MFPH PD13 setting for SC3_SS0   \hideinitializer */
...
#define SYS_CLEAR_BOD_INT_FLAG()        (SYS->BODCTL &= ~SYS_BODCTL_BODINTF_Msk)        /*!< This macro clear Brown-out interrupt flag \hideinitializer */
#define SYS_CLEAR_BOD_LPM()             (SYS->BODCTL &= ~SYS_BODCTL_BODLPM_Msk)         /*!< This macro set Brown-out detect to normal mode \hideinitializer */
#define SYS_DISABLE_BOD()               (SYS->BODCTL &= ~SYS_BODCTL_BODEN_Msk)          /*!< This macro disable Brown-out detect function \hideinitializer */
#define SYS_ENABLE_BOD()                (SYS->BODCTL |= SYS_BODCTL_BODEN_Msk)           /*!< This macro enable Brown-out detect function and set BOD_LV=3.7V \hideinitializer */
#define SYS_GET_BOD_INT_FLAG()          (SYS->BODCTL & SYS_BODCTL_BODINTF_Msk)          /*!< This macro get Brown-out detect interrupt flag \hideinitializer */
#define SYS_GET_BOD_OUTPUT()            (SYS->BODCTL & SYS_BODCTL_BODOUT_Msk)           /*!< This macro get Brown-out detector output status \hideinitializer */
#define SYS_DISABLE_BOD_RST()           (SYS->BODCTL &= ~SYS_BODCTL_BODRSTEN_Msk)       /*!< This macro enable Brown-out detect interrupt function \hideinitializer */
#define SYS_ENABLE_BOD_RST()            (SYS->BODCTL |= SYS_BODCTL_BODRSTEN_Msk)        /*!< This macro enable Brown-out detect reset function \hideinitializer */
#define SYS_SET_BOD_LPM()               (SYS->BODCTL |= SYS_BODCTL_BODLPM_Msk)          /*!< This macro set Brown-out detect to low power mode \hideinitializer */
#define SYS_SET_BOD_LEVEL(u32Level)     (SYS->BODCTL = (SYS->BODCTL & ~SYS_BODCTL_BODVL_Msk) | u32Level) /*!< This macro set Brown-out detect voltage level.u32Level=0~3 \hideinitializer */
#define SYS_IS_BOD_RST()                (SYS->RSTSTS & SYS_RSTSTS_BODRF_Msk)            /*!< This macro get previous reset source is from Brown-out detect reset \hideinitializer */
...
#define SYS_IS_LVR_RST()                (SYS->RSTSTS & SYS_RSTSTS_LVRF_Msk)             /*!< This macro get previous reset source is from Low-Voltage-Reset \hideinitializer */
...
#define SYS_IS_RSTPIN_RST()             (SYS->RSTSTS & SYS_RSTSTS_PINRF_Msk)            /*!< This macro get previous reset source is from reset pin reset \hideinitializer */
...
#define SYS_DISABLE_LVR()               (SYS->BODCTL &= ~SYS_BODCTL_LVREN_Msk)          /*!< This macro disable Low-Voltage Reset function \hideinitializer */
#define SYS_ENABLE_LVR()                (SYS->BODCTL |= SYS_BODCTL_LVREN_Msk)           /*!< This macro enable Low-Voltage Reset function \hideinitializer */
#define SYS_DISABLE_POR()               (SYS->PORCTL = 0x5AA5)                          /*!< This macro disable Power-on Reset function \hideinitializer */
#define SYS_ENABLE_POR()                (SYS->PORCTL = 0)                               /*!< This macro enable Power-on Reset function \hideinitializer */
