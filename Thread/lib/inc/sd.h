 ...
 *
 *  @param    u32IntMask    Interrupt type mask:
 *                           SD_SDIER_BLKD_IE_Msk / SD_SDIER_CRC_IE_Msk / SD_SDIER_CD0_IE_Msk / SD_SDIER_CD1_IE_Msk /
 *                           SD_SDIER_SD0_IE_Msk / SD_SDIER_SD1_IE_Msk / SD_SDIER_RITO_IE_Msk / SD_SDIER_DITO_IE_Msk /
 *                           SD_SDIER_WKUP_EN_Msk
 *
 *  @return   None.
 * \hideinitializer 
 */
#define SD_ENABLE_INT(u32IntMask)    (SD->SDIER |= (u32IntMask))
 ...
 *                           SD_SDIER_BLKD_IE_Msk / SD_SDIER_CRC_IE_Msk / SD_SDIER_CD0_IE_Msk / SD_SDIER_CD1_IE_Msk /
 *                           SD_SDIER_SD0_IE_Msk / SD_SDIER_SD1_IE_Msk / SD_SDIER_RITO_IE_Msk / SD_SDIER_DITO_IE_Msk /
 *                           SD_SDIER_WKUP_EN_Msk / SD_SDIER_CD0SRC_Msk / SD_SDIER_CD1SRC_Msk
 *
 *  @return   None.
 * \hideinitializer 
 */
#define SD_DISABLE_INT(u32IntMask)    (SD->SDIER &= ~(u32IntMask))

/**
 *  @brief    Get specified interrupt flag/status.
 *
 *  @param    u32IntMask    Interrupt type mask:
 *                           SD_SDISR_BLKD_IF_Msk / SD_SDISR_CRC_IF_Msk / SD_SDISR_CRC_7_Msk /
 *                           SD_SDISR_CRC_16_Msk / SD_SDISR_CRCSTAT_Msk / SD_SDISR_SDDAT0_Msk / SD_SDISR_CD0_IF_Msk /
 *                           SD_SDISR_CD1_IF_Msk / SD_SDISR_SD0_IF_Msk / SD_SDISR_SD1_IF_Msk / SD_SDISR_RITO_IF_Msk /
 *                           SD_SDISR_DITO_IF_Msk / SD_SDISR_CDPS0_Msk / SD_SDISR_CDPS1_Msk / SD_SDISR_SDDAT1_Msk /
 *
 *
 ...
 * \hideinitializer 
 */
#define SD_GET_INT_FLAG(u32IntMask) ((SD->SDISR & (u32IntMask))?1:0)
 ...
 *
 *  @param    u32IntMask    Interrupt type mask:
 *                           SD_SDISR_BLKD_IF_Msk / SD_SDISR_CRC_IF_Msk / SD_SDISR_CD0_IF_Msk /
 *                           SD_SDISR_CD1_IF_Msk / SD_SDISR_SD0_IF_Msk / SD_SDISR_SD1_IF_Msk /
 *                           SD_SDISR_RITO_IF_Msk / SD_SDISR_DITO_IF_Msk
 *
 *
 *  @return   None.
 * \hideinitializer 
 */
#define SD_CLR_INT_FLAG(u32IntMask) (SD->SDISR = u32IntMask)


/**
 *  @brief    Check SD Card inserted or removed.
 *
 *  @param    u32CardNum    Select SD0 or SD1. (SD_PORT0 / SD_PORT1)
 *
