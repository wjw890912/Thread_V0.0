...
/** @addtogroup NUC472_442_CLK_EXPORTED_TYPEDEF CLK Exported Type Defines
@{
*/
...
#define TMR2_MODULE      ((1UL<<30)|(1<<28)|(7<<25)           |(17<<20)|(0<<18)|(MODULE_NoMsk<<10)|( 0<<5)|CLK_APBCLK0_TMR2CKEN_Pos)   /*!< Timer2 Module  \hideinitializer */
