...
/** @addtogroup NUC472_442_PS2_EXPORTED_CONSTANTS PS2 Exported Constants
  @{
*/
 ...
 *
 *  @param    u32Mask    Clear the specified status of Ps2 module:
 *                         PS2_STATUS_FRAMEERR_Msk, PS2_STATUS_RXOV_Msk
 *
 *  @return   None
 */
 ...
 *
 *  @param    u32IntFlag interrupt flag: PS2_INTSTS_TXIF_Msk, PS2_INTSTS_RXIF_Msk
 *
